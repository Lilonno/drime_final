...
<ul>
  ...
  <li>Variables binaires représentant les événements économiques et historiques (1 : événement a eu lieu, sinon 0) : <strong>Covid</strong>, <strong>Ukraine</strong></li>
  <li>Données rajoutées lors de la finale : <strong>Le pétrole en brent</strong>, <strong>Prix unitaire de différentes énergies (gaz, électricité ...)</strong>, <strong>Brexit</strong></li>
</ul>
